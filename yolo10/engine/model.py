...
from yolo10.cfg import TASK2DATA, get_cfg, get_save_dir, _get_save_dir
from yolo10.hub.utils import HUB_WEB_ROOT
from yolo10.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load, _attempt_load_one_weight
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        if Path(model).suffix in (".yaml", ".yml"):
            ...
            self._load_only(model, task=task)
    ...
    def _load_only(self, weights: str, task=None) -> None:
        self.model, self.ckpt = _attempt_load_one_weight(weights)
        self.task = "detect"
        self.overrides = {}
        self.ckpt_path = weights
        self.overrides["model"] = weights
        ...
        **kwargs,
        ...
        if not self.predictor:
            ...
            if "project" in args or "name" in args:
                ...
                self.predictor.save_dir = _get_save_dir()
